...
// systemServer进程: WMS :从iWindow ibinder映射到服务器的窗口对象。
...
- DRAW\_PENDING(1):  WMS 正在等待客户端首帧完成（finishDrawing）

> 应用绘制 draw
> mSession.finishDrawing

- COMMIT\_DRAW\_PENDING(2): APP绘制完成,wms收到了应用的请求
- READY\_TO\_SHOW(3): 即将 performShow
